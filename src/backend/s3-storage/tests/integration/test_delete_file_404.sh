# Integration test: POST /files/delete — 404 for non-existent file
# When: POST /files/delete with non-existent fileId
...
echo "PASS: Delete non-existent file returns 404 with NOT_FOUND"
exit 0
