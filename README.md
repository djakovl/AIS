...
1. Создать feature ветку от `prod`
2. Внести изменения и сделать коммит
3. Запустить тесты локально
4. Создать pull request в `prod`
5. Дождаться прохождения CI проверок
6. Запросить code review

## Лицензия

Учебный проект для курса "Архитектура Информационных Систем".
